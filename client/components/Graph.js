...
const mnX = arr => (arr.length == 0) ? null : (arr.length == 1) ? arr[0].x - 24*3600*1000 : arr[0].x
const mxX = arr => (arr.length == 0) ? null : (arr.length == 1) ? arr[0].x + 24*3600*1000 : arr[arr.length-1].x
